...
icon = Image.open(r"/home/dineshtm/Desktop/learningspace/phonepe_visualization/image/ICN.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By T.M.Dinesh",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *T.M.Dinesh*!
...
# Top Charts - USERS          
    if Type == "Users":
        ...
        with col2:
            st.markdown("### :violet[District]")
            mycursor.execute(f"select district, sum(Registered_user) as Total_Users, sum(AppOpens) as Total_Appopens from map_user where year = {Year} and quarter = {Quarter} group by district order by Total_Users desc limit 10")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'/home/dineshtm/Desktop/learningspace/phonepe_visualization/csv/state_name.csv')
            df1.State = df2
